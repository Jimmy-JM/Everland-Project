...
public class everland5_2 {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Scanner myInput = new Scanner(System.in);
		int totalPrice = 0, useDate, order = 0, inputPreferential = 0, price = 0, manAge = 0, addOrder = 0;
		...
		ArrayList<String> arrBigSmall = new ArrayList<String>();
		ArrayList<Integer> arrPrice = new ArrayList<Integer>();
		ArrayList<Integer> arrOrder = new ArrayList<Integer>();
		...
		for(int index = 0; index < arrTicket.size(); index++) {
			...
			totalPrice = arrPrice.get(index) * arrOrder.get(index);
		}
		System.out.print("==========================================");
